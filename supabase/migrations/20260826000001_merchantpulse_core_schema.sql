...
-- Service role key automatically bypasses RLS by default.
-- Authenticated users are granted read access to their tenant data.
-- ====================================================================
...
-- Authenticated merchant users can query their tenant data
