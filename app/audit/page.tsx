    ...
    <MaterialAppLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/60 dark:bg-slate-900/60 light:bg-white p-6 rounded-3xl border border-slate-800 dark:border-slate-800 light:border-slate-200 m3-elevation-1">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-500 text-xs font-mono mb-2">
        ...
        {/* Filters */}
        <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-900/40 dark:bg-slate-900/40 light:bg-slate-100 p-4 rounded-2xl border border-slate-800 dark:border-slate-800 light:border-slate-300">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl bg-slate-950 dark:bg-slate-950 light:bg-white border border-slate-800 dark:border-slate-800 light:border-slate-300 text-slate-100 dark:text-slate-100 light:text-slate-900 text-xs font-mono focus:outline-none focus:border-blue-500"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="px-3 py-2 rounded-xl bg-slate-950 dark:bg-slate-950 light:bg-white border border-slate-800 dark:border-slate-800 light:border-slate-300 text-slate-100 dark:text-slate-100 light:text-slate-900 text-xs font-mono focus:outline-none focus:border-blue-500"
            >
        ...
        {/* Audit Data Table */}
        <div className="bg-slate-900/80 dark:bg-slate-900/80 light:bg-white rounded-3xl border border-slate-800 dark:border-slate-800 light:border-slate-200 overflow-hidden m3-elevation-2">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-800 dark:border-slate-800 light:border-slate-200 bg-slate-950/60 dark:bg-slate-950/60 light:bg-slate-50 text-slate-400 dark:text-slate-400 light:text-slate-600 font-mono text-[11px] uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-slate-800/60 dark:divide-slate-800/60 light:divide-slate-200 font-mono text-xs text-slate-200 dark:text-slate-200 light:text-slate-800">
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-800/40 dark:hover:bg-slate-800/40 light:hover:bg-slate-100 transition-colors">
                    <td className="py-3.5 px-4">
                      <div className="font-bold text-white dark:text-white light:text-slate-900">{log.id}</div>
                      <div className="text-[10px] text-slate-500">{log.timestamp}</div>
                    </td>
                    <td className="py-3.5 px-4 text-blue-500 font-bold">{log.opportunityId}</td>
                    ...
                    <td className="py-3.5 px-4 text-slate-400 dark:text-slate-400 light:text-slate-600 text-[11px] max-w-xs truncate">
                      {log.ruleEvaluated}
                    </td>
                    <td className="py-3.5 px-4 text-slate-400 dark:text-slate-400 light:text-slate-600 font-mono text-[11px]">
                      {log.razorpayRef}
                    </td>
                  </tr>
                ))}
