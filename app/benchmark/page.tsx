      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/60 p-6 rounded-3xl border border-slate-800 m3-elevation-1">
          ...
          <button
            ...
            disabled={isRunning}
            className="flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold font-mono shadow-lg shadow-blue-600/30 transition-all disabled:opacity-50"
          >
            {isRunning ? (
        ...
        {/* Configuration Bar */}
        <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs">
          <div className="flex items-center gap-4">
            <span className="text-slate-400 font-bold">Select Batch Size:</span>
          ...
          <span className="text-slate-500 text-[11px]">
            Held-Out Evaluation Split: <strong className="text-slate-300">20% Validation Set</strong>
          </span>
        </div>
        ...
        {result && result.metrics && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-5 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-3 m3-elevation-1">
                <div className="text-xs text-slate-400 font-mono">Baseline 1: No Intervention</div>
                <div className="text-xl font-bold text-slate-300">₹0 Recovered</div>
              ...
              <div className="p-5 rounded-3xl bg-slate-900/60 border border-amber-500/30 space-y-3 m3-elevation-1">
                <div className="text-xs text-amber-400 font-mono">Baseline 2: Static Rules</div>
              ...
              <div className="p-5 rounded-3xl bg-gradient-to-br from-blue-900/40 via-slate-900 to-indigo-900/40 border border-blue-500/50 space-y-3 m3-elevation-3">
                <div className="text-xs text-blue-400 font-mono font-bold flex items-center gap-1.5">
                ...
                <p className="text-[11px] text-slate-300 font-mono">
                  Attributed Recovery Rate: <strong className="text-white">{result.metrics.attributedRecoveryRatePct}%</strong>
                </p>
              </div>
            </div>

            {/* Detailed Batch Metrics Table */}
            <div className="p-6 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-4 m3-elevation-2 font-mono text-xs">
              <h3 className="font-bold text-white uppercase tracking-wider text-slate-400">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800">
                  ...
                  <div className="text-base font-bold text-white">{result.metrics.totalEventsProcessed}</div>
                </div>
